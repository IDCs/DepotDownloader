...
namespace DepotDownloader
{
  static class Util
  {
    ...
    public static bool VerifyHash(HashAlgorithm hashAlgorithm, string input, byte[] hash)
    {
      // Hash the input.
    ...
    public static byte[] GetChecksum(string filePath, HashAlgorithm algo)
    {
      byte[] checksum = null;
      using (var fs = File.Open(filePath, FileMode.Open))
      {
        checksum = algo.ComputeHash(fs);
      }
